...
class HelpRequest(models.Model):
    ...
    district = models.ForeignKey('accounts.Region', on_delete=models.CASCADE, default=1)
    level = models.ForeignKey('accounts.Level', on_delete=models.CASCADE, default=1)
    language = models.ForeignKey('accounts.Language', on_delete=models.CASCADE)
